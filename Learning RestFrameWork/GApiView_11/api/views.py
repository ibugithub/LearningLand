...
# # ..... This class is for Getting all the data and create data ........
class StudentApi1(GenericAPIView, ListModelMixin, CreateModelMixin):
...
# ....... This class is for updating , Getting data by pk , deleting data .......
class StudentApi2(GenericAPIView, RetrieveModelMixin, UpdateModelMixin, DestroyModelMixin):
    queryset = Student.objects.all()
    serializer_class = Student_Serializer 
